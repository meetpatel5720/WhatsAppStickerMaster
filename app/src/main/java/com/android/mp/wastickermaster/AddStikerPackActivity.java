...
public class AddStikerPackActivity  extends BaseActivity {

    public static final int ADD_PACK = 200;
    protected Activity context;

    public AddStikerPackActivity(Activity context) {
        this.context = context;
    }

    StickerPackListActivity.AddToWhatsApp addToWhatsApp= new StickerPackListActivity.AddToWhatsApp(){
        ...
        public void addStickerPackToWhatsApp(String identifier, String stickerPackName) {
            ...
            try {
                context.startActivityForResult(intent, ADD_PACK);
